...
@Component
public class InteractiveScreenImpl implements InteractiveScreen {

    private static final Logger LOGGER = LoggerFactory.getLogger(InteractiveScreenImpl.class);

    private final InputReader inputReader ;

    private final ParkingService parkingService;

    public InteractiveScreenImpl(InputReader inputReader, ParkingService parkingService) {
